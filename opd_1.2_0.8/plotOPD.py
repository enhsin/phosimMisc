...
def plotZMX(pfn,zfn,fx,fy,extraText):
    tx='field angle = '+fx+r'$^\circ$'+', '+fy+r'$^\circ$'+' wavelength = 770 nm'+extraText
    ...
    phosim=fits.getdata(pfn)*1000/0.77
    phosim=phosim[::-1,:]
...
plotZMX(sys.argv[1],sys.argv[2],sys.argv[3],sys.argv[4],sys.argv[5])
